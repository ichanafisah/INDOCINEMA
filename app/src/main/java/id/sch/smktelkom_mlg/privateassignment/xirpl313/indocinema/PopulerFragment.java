...
import id.sch.smktelkom_mlg.privateassignment.xirpl313.indocinema.adapter.PopulerAdapter;
...
public class PopulerFragment extends Fragment {
    ...
    private void downloadDataResource() {
        String url = "\n" +
                "https://api.themoviedb.org/3/movie/top_rated?api_key=5c1907a4d80e43ad36c9141b6e69a8d6&language=en-US&page=1";
